...
public class GameData {
    ...
    public List<Card> getAllCards() {
        return Arrays.asList(
                ...
                new TrainerCard(208, "D1", "Super Energy Removal", false, true, false, false),
                new TrainerCard(208, "D2", "Switch", false, false, false, false),
                new TrainerCard(208, "D3", "Pokemon Center", false, false, false, true),
                new TrainerCard(208, "D4", "Poke Ball", false, false, true, false),
                new TrainerCard(208, "D5", "Scoop Up", false, false, false, true),
                new TrainerCard(208, "D6", "Computer Search", false, false, true, false),
                new TrainerCard(208, "D7", "Pokedex", false, false, true, false),
                new TrainerCard(208, "D8", "PlusPower", false, false, false, false),
                new TrainerCard(208, "D9", "Defender", false, false, false, false),
                new TrainerCard(208, "DA", "Item Finder", false, false, false, false),
                new TrainerCard(208, "DB", "Gust of Wind", false, true, false, false),
                new TrainerCard(208, "DC", "Devolution Spray", false, false, false, true),
                new TrainerCard(208, "DD", "Potion", false, false, false, true),
                new TrainerCard(208, "DE", "Super Potion", false, false, false, true),
                new TrainerCard(208, "DF", "Full Heal", false, false, false, true),
                new TrainerCard(208, "E0", "Revive", false, false, false, false),
                new TrainerCard(208, "E1", "Maintenance", true, false, false, false),
                new TrainerCard(208, "E2", "Pokemon Flute", false, true, false, false),
                new TrainerCard(208, "E3", "Gambler", true, false, false, false),
                new TrainerCard(208, "E4", "Recycle", false, false, false, false)
        );
    }
}
