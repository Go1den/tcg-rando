...
public class PokemonCard extends Card {
    ...
    public PokemonCard(int cardID, String hex, String name, int level, int evolutionStage, int hp, Move move1, Move move2,
                       TypeSet weaknesses, TypeSet resistances, MoveCost retreatCost, List<Integer> evolvesFromCardIDs,
                       List<Integer> evolvesIntoCardIDs, boolean evolvesFromFossil) {
